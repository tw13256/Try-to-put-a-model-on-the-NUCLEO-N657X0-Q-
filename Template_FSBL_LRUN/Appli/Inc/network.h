...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "MIT_BIH_quant_114"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (250)
...
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (2)
